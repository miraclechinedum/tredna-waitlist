...
export const countries: Country[] = [
  ...
  { code: 'KN', name: 'Saint Kitts & Nevis', dialCode: '+1-869', flag: '🇰🇳' },
  { code: 'LC', name: 'Saint Lucia', dialCode: '+1-758', flag: '🇱🇨' },
  { code: 'PM', name: 'Saint Pierre & Miquelon', dialCode: '+508', flag: '🇵🇲' },
  { code: 'VC', name: 'Saint Vincent & Grenadines', dialCode: '+1-784', flag: '🇻🇨' },
  ...
  { code: 'TC', name: 'Turks & Caicos Islands', dialCode: '+1-649', flag: '🇹🇨' },
